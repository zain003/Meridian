...
5. `context/progress-tracker.md` — Current implementation phase, completed tasks, and active roadmap focus.
6. `context/ai-workflow-rules.md` — Spec-driven incremental workflow, task splitting boundaries, and DoD checklist.
7. `context/feature-specs/000-shared-contracts.md` — Single source of truth for Prisma models, global TypeScript types, RBAC patterns, and shared Zod schemas.
8. The active feature spec under `context/feature-specs/` matching the user's task.
