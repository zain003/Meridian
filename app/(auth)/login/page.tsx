      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <Button
            ...
            className="w-full h-9 bg-zinc-900/50 hover:bg-zinc-800 border-zinc-800 text-xs text-zinc-300 font-medium flex items-center justify-center gap-2.5 shadow-sm"
          >
